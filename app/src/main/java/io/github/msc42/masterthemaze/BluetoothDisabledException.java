...
/**
 * Represents an exception, which is thrown if Bluetooth was disabled by the user while using it.
 *
 * @author Stefan Constantin
 */
class BluetoothDisabledException extends Exception {

    private static final long serialVersionUID = 1L;


    protected BluetoothDisabledException() {
        super();
    }

    protected BluetoothDisabledException(String message) {
        super(message);
    }

    protected BluetoothDisabledException(String message, Throwable cause) {
        super(message, cause);
    }
}
